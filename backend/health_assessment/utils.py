...
heart_model = loadModel('health_assessment\Heart_health_module\heart_disease_predictor.pkl')
sleep_model = loadModel('health_assessment\Sleep_quality_module/sleep_disorder_predictor.pkl')
metabolism_model = loadModel('health_assessment\Metabolism_module/metabolic_syndrome_predictor.pkl')
...
# this thing will be exported
healthPredictor = PredictionOrechestrator(models=model_list, preprocessors=preprocessors_list, names=names_list)